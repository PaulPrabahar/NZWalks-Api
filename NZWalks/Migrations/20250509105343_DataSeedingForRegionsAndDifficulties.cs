...
{
    /// <inheritdoc />
    public partial class DataSeedingForRegionsAndDifficulties : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a25e3189-ce95-40c3-8974-1fd7e32f2bff"), "Medium" },
                    { new Guid("e0bc3d57-983a-44e0-a49b-9ea53649505f"), "Hard" },
                    { new Guid("f478c62b-9720-45fc-bae8-3c2f71740d46"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a25e3189-ce95-40c3-8974-1fd7e32f2bff"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("e0bc3d57-983a-44e0-a49b-9ea53649505f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f478c62b-9720-45fc-bae8-3c2f71740d46"));
